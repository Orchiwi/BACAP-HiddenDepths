...
execute if entity @s[advancements={bacaphd:challenges/death_by_committee=true}] run scoreboard players set @s bacaphd_committee -1
execute unless entity @s[advancements={bacaphd:challenges/death_by_committee=true}] if score @s bacaphd_committee matches -1 run scoreboard players set @s bacaphd_committee 60
