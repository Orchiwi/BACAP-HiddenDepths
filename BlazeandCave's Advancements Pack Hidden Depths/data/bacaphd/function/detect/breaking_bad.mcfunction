...
advancement revoke @s only bacaphd:challenges/breaking_bad brewed
scoreboard players add @s bacaphd_brews 1
execute if score @s bacaphd_brews matches 1000.. run advancement grant @s only bacaphd:challenges/breaking_bad
