# B13 Ominous Marathon. Reject this credit if it is within 256 blocks of chamber 3.
scoreboard players operation @s bacaphd_dx = @s bacaphd_px
scoreboard players operation @s bacaphd_dx -= @s bacaphd_lx3
...
scoreboard players operation @s bacaphd_dz -= @s bacaphd_lz3
